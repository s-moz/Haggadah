...
\begin{center}
	%\begin{itemize}
		\color{sectioncolour}
		\item 	\largehebrew{דָּם}  |  Dam  |  Blood
		\item 	\largehebrew{צְפַרְדֵּעַ}  |  Tz'fardeiya  |  Frogs
		\item 	\largehebrew{כִּנִּים}  |  Kinim  |  Lice
		\item	\largehebrew{עַרוֹב}  |  A'rov  |  Beasts
		\item	\largehebrew{דֶּבֶר}  |  Dever  |  Cattle disease  
		\item	\largehebrew{שְׁחִין}  |  Sh'chin  |  Boils
		\item 	\largehebrew{בָּרָד}  |  Barad  |  Hail
		\item 	\largehebrew{אַרְבֶּה}  |  Ar'beh  |  Locusts
		\item 	\largehebrew{חוֹשֶׁךְ}  |  Choshech  |  Darkness
		\item 	\largehebrew{מַכַּת בְּכוֹרוֹת}  |  Makkat b'chorot  |  Death of the Firstborn
	%\end{itemize}	
\end{center}
\par}
