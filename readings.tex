...
\newcommand{\DayyeinuText}{%
	...
	\begin{enumerate}
		...
		%12	
		\item{ 
		\raggedright{\color{midblue}If He had brought us before Mount Sinai...\\
		...
		\raggedright{\color{midblue}If He had given us the Torah...\\
			...
			\vspace*{0.25ex}
			\largehebrew{\color{darkblue}אִלּוּ נָתַן לָנוּ אֶת הַתּוֹרָה...}\\}
		...
		\raggedright{\color{midblue}If He had brought us into the land of Israel...\\
			\textit{\color{darkblue}Ilu hichnisanu l'eretz yisra'eil...}\\
			\vspace*{0.25ex}
...
\vspace*{2ex}
	\begin{multicols}{2}
	\nopagebreak \color{black} \raggedright {large V každém pokolení je povinností každého Žida vidět sama sebe, jako 
...
\newcommand{\ElijahText}{
	\color{midblue} \textit{\centering Pour Elijah's cup of wine.\\
